...
import { createResultsDb } from "./create-results-db"

const NULLISH_PREDICTIONS: Record<
	number,
...
> = {
	...
	49: null, 50: null, 51: null, 52: null, 53: null, 54: null,
	55: null, 56: null, 57: null, 58: null, 59: null, 60: null,
	61: null, 62: null, 63: null, 64: null, 65: null, 66: null,
	67: null, 68: null, 69: null, 70: null, 71: null, 72: null,
}

async function seed() {
	await createResultsDb("admin-predictions", NULLISH_PREDICTIONS)
	console.log("✅ admin-predictions inserted")
}
